                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="POST" action="editar_privilegio.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Descripcion del privilegio" name="privilegio" value="<?php echo $data['privilegio']; ?>">
                            </div>
                            <input type="submit" name="editar_privilegio" value="Confirmar" class="btn btn-success btn-lg "/>
                        </form>
                        </br>
                        </br>
                    </div>
